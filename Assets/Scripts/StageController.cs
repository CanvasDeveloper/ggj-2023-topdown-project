...
public class StageController : MonoBehaviour
{
    ...
    [SerializeField] List<Transform> spawnPontsKamikaze = new List<Transform>();
    ...
    private IEnumerator IE_Wave()
    {
        ...
        for (int i = 0; i < totalEnemies; i++)
        {
            ...
            if (tagsEnemy.Contains("Kamizaze"))
                ...
                objEnemy = ObjectPooler.Instance.SpawnFromPool(tagsEnemy[id], spawnPontsKamikaze[IDspawn].position, Quaternion.identity);
